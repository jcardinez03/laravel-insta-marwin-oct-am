...
class PostController extends Controller
{
    ...
    # This will open the Create Post page.
    ...
    public function store(Request $request)
    {
        ...
        // $category_post = ['category_id' => 1];
        // $category_post = ['category_id' => 4]; 
    ...
    public function update(Request $request, $id)
    {
        ...
        # 3. Delete all the category_post related to the post being updated
