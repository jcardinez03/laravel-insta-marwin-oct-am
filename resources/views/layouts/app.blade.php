        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    {{-- [SOON] Search bar for logged in users. --}}
                    @auth
                        {{-- this will not show up i nthe admin side --}}
                        @if (!request()->is('admin/*'))
                            <ul class="navbar nav mx-auto">
                                <form action="{{ route('search') }}" method="get" style="width: 100px">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <button id="account-dropdown" class="btn nav-link" data-bs-toggle="dropdown">
                                    @if (Auth::user()->avatar)
